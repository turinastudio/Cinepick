...
const extractorRegistry = [
  ...
  { id: "streamwish", source: "cloudstream", aliases: ["wishembed", "streamwish", "strwish", "streamgg", "kswplayer", "swhoi", "multimovies", "uqloads", "neko-stream", "swdyu", "iplayerhls", "hlswish", "hanerix"], resolve: extractStreamWish },
  ...
  { id: "vidhide", source: "cloudstream", aliases: ["ahvsh", "streamhide", "guccihide", "streamvid", "vidhide", "kinoger", "smoothpre", "dhtpre", "peytonepre", "earnvids", "ryderjet", "vidhidehub", "filelions", "vidhidevip", "vidhidepre", "cvid"], resolve: extractVidHide },
